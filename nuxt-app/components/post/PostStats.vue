<template>
  ...
  >
    ...
    <p
      class="absolute inline-flex p-1 text-red-600 bg-red-100 rounded top-4 right-4"
    >
      <svg
  ...
  >
    ...
    <p
      class="absolute inline-flex p-1 text-green-600 bg-green-100 rounded top-4 right-4"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="w-4 h-4"
